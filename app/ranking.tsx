...
const { data, error: queryError } = await supabase  
  ...
  setError(  
    err?.message || 'تعذر تحميل الترتيب.'  
  );  
} finally {  
  setLoading(false);  
}
...
if (index === 0) return '#D7A94B';
if (index === 1) return '#B9BEC8';
if (index === 2) return '#B77B55';
      ...
      {!loading &&  
        ...
        players.length === 0 && (  
          <View style={styles.stateCard}>  
            ...
            <Text style={styles.stateText}>  
              سيظهر اللاعبون هنا بعد إنشاء حساباتهم  
              وبدء اللعب.  
            </Text>  
          </View>  
        )}  
          ...
          <View style={styles.infoCard}>  
            ...
            <View style={styles.infoTextContainer}>  
              ...
              <Text style={styles.infoText}>  
                يتم ترتيب اللاعبين حسب التقييم، ثم عدد  
                الانتصارات، ثم عدد المباريات.  
              </Text>  
            </View>  
          </View>  
        )}  
